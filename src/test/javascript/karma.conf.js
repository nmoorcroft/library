...
files = [
  JASMINE,
  JASMINE_ADAPTER,
  'src/test/javascript/lib/mocks.js',
  'src/test/javascript/lib/karma.js',
  ...
  'src/main/resources/assets/js/lib/angular.min.js',
...
preprocessors = {
  'src/main/resources/assets/js/*.js' : 'coverage'
};
